    ...
    <div class="row mt-5 mb-3 justify-content-sm-center">
        ...
        <div class="col-lg-3 col-sm-auto mb-3">
            <div class="d-flex justify-content-center">
                <div class="card" role="tab" id="heading<?= $v->workID; ?>" style="width: 20rem; height: 25rem;">
                    <a data-toggle="collapse" data-parent="#accordion" href="#collapse<?= $v->workID; ?>"
                           aria-expanded="true" aria-controls="collapse<?= $v->workID; ?>">
                    ...
                    <div class="image-card">
                        <div class="media media-back">
                            ...
                            <div class="media-body" style="width: 100%">
                                ...
                                <a href="<?= $v->link; ?>">
                                    <img class="link" src="<?= BASE_URL; ?>/public/img/link-3.svg" alt="lien"> -><em>Lien projet</em>
                                </a>
                            </div>
                            <!-- /.media-body -->
                        </div>
